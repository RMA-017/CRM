...
function mapScheduleItemToPlannerCard(item) {
  ...
  return {
    ...
    financeTicketId: String(item?.financeTicketId ?? item?.finance_ticket_id ?? "").trim(),
    financeTicketStatus: String(item?.financeTicketStatus ?? item?.finance_ticket_status ?? "").trim().toLowerCase(),
    financeTicketTotalUzs: normalizeAppointmentMoneyAmount(item?.financeTicketTotalUzs ?? item?.finance_ticket_total_uzs),
    financeTicketPaidAmountUzs: normalizeAppointmentMoneyAmount(item?.financeTicketPaidAmountUzs ?? item?.finance_ticket_paid_amount_uzs),
    financeTicketRemainingAmountUzs: normalizeAppointmentMoneyAmount(item?.financeTicketRemainingAmountUzs ?? item?.finance_ticket_remaining_amount_uzs),
    financeTicketPaymentState: String(item?.financeTicketPaymentState ?? item?.finance_ticket_payment_state ?? "").trim().toLowerCase(),
