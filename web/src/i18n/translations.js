...
export const LITERAL_TRANSLATIONS = Object.freeze([
  ...
  { en: "Period", uz: "Davr", ru: "Период" },
  { en: "Today", uz: "Bugun", ru: "Сегодня" },
  { en: "Current month", uz: "Joriy oy", ru: "Текущий месяц" },
  { en: "Previous month", uz: "O'tgan oy", ru: "Прошлый месяц" },
  ...
  { en: "Export to Google Sheets", uz: "Google Sheetsga chiqarish", ru: "Экспорт в Google Sheets" },
  { en: "Google Sheets export", uz: "Google Sheets eksporti", ru: "Экспорт в Google Sheets" },
  { en: "Google Sheets URL", uz: "Google Sheets manzili", ru: "Ссылка на Google Sheets" },
  { en: "Google Sheets URL is required.", uz: "Google Sheets manzilini kiriting.", ru: "Укажите ссылку на Google Sheets." },
  { en: "Year", uz: "Yil", ru: "Год" },
  { en: "Export year is invalid.", uz: "Eksport yili noto'g'ri.", ru: "Некорректный год экспорта." },
  { en: "Editor access", uz: "Muharrir ruxsati", ru: "Доступ редактора" },
  { en: "Sheets", uz: "Sahifalar", ru: "Листы" },
  { en: "Export", uz: "Eksport", ru: "Экспорт" },
  { en: "Exporting...", uz: "Eksport qilinmoqda...", ru: "Экспорт..." },
  { en: "Export completed.", uz: "Eksport yakunlandi.", ru: "Экспорт завершен." },
  { en: "Google Sheets export failed.", uz: "Google Sheetsga eksport qilib bo'lmadi.", ru: "Не удалось экспортировать в Google Sheets." },
  { en: "Failed to load Google Sheets export settings.", uz: "Google Sheets eksport sozlamalarini yuklab bo'lmadi.", ru: "Не удалось загрузить настройки экспорта Google Sheets." },
  { en: "Google Sheets service account is not configured.", uz: "Google Sheets service account sozlanmagan.", ru: "Сервисный аккаунт Google Sheets не настроен." },
  ...
  { en: "Used", uz: "Ishlatildi", ru: "Использовано" },
  ...
  { en: "Appointment", uz: "Dars", ru: "Занятие" },
  { en: "Cancelled appointment", uz: "Bekor qilingan dars", ru: "Отмененное занятие" },
  { en: "No-show appointment", uz: "Kelmagan dars", ru: "Неявка на занятие" },
  ...
  { en: "Appointment Date", uz: "Dars sanasi", ru: "Дата занятия" },
  { en: "Appointment Status", uz: "Dars statusi", ru: "Статус занятия" },
  ...
  { en: "Client Discounts", uz: "Client skidkalari", ru: "Скидки клиентов" },
  { en: "New Client Discount", uz: "Yangi client skidkasi", ru: "Новая скидка клиента" },
  { en: "Create discount", uz: "Skidka yaratish", ru: "Создать скидку" },
  { en: "No discounts.", uz: "Skidkalar yo'q.", ru: "Скидок нет." },
  { en: "Created From", uz: "Yaratilgan sanadan", ru: "Дата создания с" },
  { en: "Created To", uz: "Yaratilgan sanagacha", ru: "Дата создания до" },
  { en: "Management", uz: "Boshqaruv", ru: "Управление" },
  { en: "Enable", uz: "Yoqish", ru: "Вкл." },
  { en: "Disable", uz: "O'chirish", ru: "Откл." },
  { en: "Disable discount", uz: "Skidkani o'chirish", ru: "Отключить скидку" },
  { en: "Disable reason", uz: "O'chirish sababi", ru: "Причина отключения" },
  ...
  { en: "By service", uz: "Xizmat bo'yicha", ru: "По услугам" },
  { en: "Discount is required for each service.", uz: "Har bir xizmat uchun skidka yozish shart.", ru: "Укажите скидку для каждой услуги." },
  { en: "Percent discount cannot exceed 100.", uz: "Foizli skidka 100% dan oshmasligi kerak.", ru: "Процент скидки не может быть больше 100." },
  { en: "Discount cannot be greater than service price.", uz: "Skidka xizmat narxidan katta bo'lishi mumkin emas.", ru: "Скидка не может быть больше цены услуги." },
  { en: "Discount cannot be greater than service total.", uz: "Skidka xizmatlarning umumiy summasidan katta bo'lishi mumkin emas.", ru: "Скидка не может быть больше общей суммы услуги." },
  ...
  { en: "Close finance discounts panel", uz: "Finance skidkalari panelini yopish", ru: "Закрыть панель скидок клиентов" },
