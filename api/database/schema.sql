...
CREATE TABLE finance_cash_sessions (
  ...
  closing_balance_uzs INTEGER,
  expected_balance_uzs INTEGER,
...
CREATE TABLE finance_google_sheets_exports (
  organization_id INTEGER NOT NULL REFERENCES organizations(id) ON DELETE CASCADE,
...
CREATE INDEX idx_finance_google_sheets_exports_updated
