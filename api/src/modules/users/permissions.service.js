...
const ROLE_PERMISSION_COPY_MIGRATIONS = Object.freeze([
  ...
  {
    from: PERMISSIONS.APPOINTMENTS_STATISTICS_PLANNER_REPORT,
    to: PERMISSIONS.APPOINTMENTS_STATISTICS_PLANNER_REPORT_ONLY
  },
  {
    from: PERMISSIONS.FINANCE_REPORTS_READ,
    to: PERMISSIONS.FINANCE_AUDIT_READ
  }
]);
