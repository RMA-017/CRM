...
export const financeRouteSchemas = Object.freeze({
  ...
  reportsQuery: {
    ...
    properties: {
      ...
      appointmentDateFrom: { type: "string", pattern: "^\\d{4}-\\d{2}-\\d{2}$" },
      appointmentDateTo: { type: "string", pattern: "^\\d{4}-\\d{2}-\\d{2}$" },
      appointment_date_from: { type: "string", pattern: "^\\d{4}-\\d{2}-\\d{2}$" },
      appointment_date_to: { type: "string", pattern: "^\\d{4}-\\d{2}-\\d{2}$" },
